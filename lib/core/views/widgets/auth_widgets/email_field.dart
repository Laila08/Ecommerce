...
class EmailField extends StatelessWidget {
  ...
  const EmailField({super.key, required this.authCubit, this.isValidEmail, required this.autovalidateMode});
  ...
  Widget build(BuildContext context) {
    return AppTextField(
      ...
      onEditingCompleteFun: () => FocusScope.of(context).requestFocus(authCubit.passwordFocusNode),
    );
  }
}